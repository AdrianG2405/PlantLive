...
export function Footer() {
  return <footer>
    ...
    <span>Fotografías: iNaturalist y Wikimedia Commons · <Link to="/plantas-guia">Guías de plantas</Link> · <Link to="/blog">Blog</Link> · <Link to="/privacidad">Privacidad</Link> · <Link to="/condiciones">Condiciones</Link></span>
  </footer>;
}
