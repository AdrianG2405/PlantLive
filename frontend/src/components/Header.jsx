...
import { BookOpen, Bot, CalendarDays, HeartPulse, LayoutDashboard, Leaf, LogIn, LogOut, Search, Settings, Sprout, Users } from "lucide-react";
...
export function Header() {
  ...
  <nav className="mobile-nav" aria-label="Navegación principal">
    ...
    <NavLink className={active} to="/chatbot"><Bot size={20} /><span>Chatbot</span></NavLink>
  </nav></>;
}
