...
export function DiagnosisPage({ plants, addPlant, notify, authenticated }) {
  ...
  return <><section className="diagnosis-hero"><div><span className="kicker light">IDENTIFICA · ANALIZA · AÑADE</span><h1>Conoce tu planta<br /><em>a partir de una foto.</em></h1><p>No necesitas saber su nombre. Haz una foto, descubre qué especie puede ser y añádela a tu jardín con sus cuidados.</p><div className="diagnosis-trust"><span><ShieldCheck size={16} /> Tú decides qué fotos analizar</span><span><Sparkles size={16} /> Resultado en unos segundos</span></div></div><div className="diagnosis-hero-steps"><article><b>01</b><span>Sube una foto</span></article><article><b>02</b><span>Identifica y revisa</span></article><article><b>03</b><span>Añádela a tu jardín</span></article></div></section>
    <section className="section doctor diagnosis-doctor"><div className="doctor-copy"><span className="kicker light">ANÁLISIS VISUAL</span><h2>Una buena foto ayuda a acertar</h2><p>Puedes usar esta herramienta tanto para identificar una planta desconocida como para revisar el estado de una que ya tienes.</p><ul><li>Fotografía la planta completa con buena luz</li><li>Añade un primer plano de sus hojas</li><li>Si hay daños, muestra también tallos y sustrato</li></ul></div><div className="diagnosis-panel"><div className="diagnosis-panel-head"><span>1</span><div><b>Añade imágenes de tu planta</b><small>Puedes subir hasta 4 vistas diferentes</small></div></div>
