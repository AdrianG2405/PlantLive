...
export function LegalPage() {
  return <section className="section legal-page"><span className="kicker">PRIVACIDAD</span><h1>Cómo trata PlantLive tus datos</h1><p><b>Última actualización:</b> 11 de agosto de 2026.</p>
    ...
    <h2>Tus derechos</h2><p>Desde Ajustes puedes rectificar preferencias, descargar una copia de tus datos y eliminar la cuenta. Si ya no tienes la aplicación, también puedes utilizar la <Link to="/eliminar-cuenta">página pública de eliminación de cuenta</Link>. Puedes solicitar acceso, rectificación, supresión, limitación, oposición o portabilidad escribiendo a {contact}. Si consideras que el tratamiento no es correcto, puedes reclamar ante la autoridad de protección de datos correspondiente.</p>
