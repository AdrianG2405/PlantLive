...
export function TermsPage() {
  return <section className="section legal-page"><span className="kicker">CONDICIONES DE USO</span><h1>Condiciones de PlantLive</h1><p><b>Última actualización:</b> 31 de julio de 2026.</p>
    ...
    <h2>Finalidad del servicio</h2><p>PlantLive es un servicio web gratuito, sin pagos ni publicidad. Permite organizar plantas, programar recordatorios y obtener orientación automatizada sobre identificación y cuidados. Las fechas son recordatorios para revisar el estado real de la planta, no órdenes automáticas de riego o tratamiento.</p>
